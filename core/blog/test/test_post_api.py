...
class TestPostApi:
    ...
    def test_create_post_response_201_status(self,api_client,common_user,test_category):
        url = reverse("blog:api-v1:post-list")
        data = {
            "title": "test",
            "content": "description",
    ...
    def test_create_post_invalid_date_response_400_status(self,api_client,common_user):
        url = reverse("blog:api-v1:post-list")
        data = {
            "title": "test",
            "content": "description",
