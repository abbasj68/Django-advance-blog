...
from .serializers import (RegistrationSerializers,CustomAuthTokenSerializer,
                          CustomTokenObtainPairSerializer,ChangePasswordSerializers,ProfileSerializer,ActivationResendSerializer)
...
class RegistrationApiView(generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs ):
        ...
        if serializer.is_valid():
            ...
            email_obj = EmailMessage('email/activation_email.tpl', {'token':token},'abbasj.gg@gmail.com', to=[email])
...
class TestEmailSend(generics.GenericAPIView):
    ...
    def get(self, request, *args, **kwargs):
        self.email = "abbas123@gmail.com"
        user_obj = get_object_or_404(User, email = self.email)
        token = self.get_tokens_for_user(user_obj)
        email_obj = EmailMessage('email/hello.tpl', {'token':token},'abbasj.gg@gmail.com', to=[self.email])
        EmailThread(email_obj).start()
...
class ActivationResendApiView(generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        token = self.get_tokens_for_user(user_obj)
        email_obj = EmailMessage('email/activation_email.tpl', {'token':token},'abbasj.gg@gmail.com', to=[user_obj.email])
        EmailThread(email_obj).start()
